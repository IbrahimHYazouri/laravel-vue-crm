            ...
            <div class="p-4 border-b border-gray-200 ">
                <div class="flex flex-wrap gap-2">
                    <Link
                        ...
                        class="w-fit px-2 py-1 text-sm bg-blue-600 text-white rounded hover:bg-blue-700">Start new
                        Project
                    </Link>
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 ">
                    ...
                    <tr v-if="projects" v-for="project in projects.data" class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ project.user.full_name }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ project.status }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ project.deadline_formatted }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end space-x-2">
                                ...
                                <span v-if="$page.props.auth.permissions.includes('delete')" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                             viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
